...
for (const control of [
  ...
  "Ask a manager to change the time",
  "Ask a manager to cancel this job",
  "Ask a manager to move the date",
  "Trucks",
  "Ask a manager to take this truck out of service",
  "Ask a manager to return this truck to service",
  "Current truck load",
  "Record starting load",
  "Record dump reset",
  "Record metal-yard reset",
  "Money &amp; payroll",
  "Ask a manager to save this follow-up",
  "Ask a manager to approve this bonus",
  "Ask a manager to approve this correction",
  "Krewe",
  "Mark available",
  "Mark unavailable",
  "Ask a manager to schedule this call-in",
  "Team messages",
  "Ask a manager to post this update",
  "Customer follow-up",
  "Ask a manager to approve this plan",
  "Call customer",
  "Open text message",
  "Save what happened",
  "Google reviews",
  "Missed leads",
  "Ask a manager to confirm this match",
  "Ask a manager to use this job instead",
  "Systems",
  "What is working and what needs attention",
  "Ask a manager to save this plan",
  "GPS trackers",
  "Mark called",
  "Recent activity",
]) {
