...
export type DesktopCrewMember = CrewAmounts & { id: string; name: string; initials: string; role: string; truck: string; working: boolean; clockIn: string; clockOut: string; hourlyRate: number | null; status: string; issue: string; payNote?: string; version: string; actionVersions?: { correction: string; bonus: string }; correction: { clockIn: string; clockOut: string; hourlyRate: number; note: string; updatedBy: string; updatedAt: string } | null; days: Array<CrewAmounts & { date: string; clockIn: string; clockOut: string }> };
