...
assert.match(jobsMapSource, /if \(!selectedJobKey && !selectedTruckName\) return;/);
assert.match(jobsMapSource, /<article ref=\{mapSelectionRef\} className="ops-jobs-map-selection ops-jobs-map-truck-selection is-truck"/);
