...
export const INSPECTION_PUBLIC_PATHS = ["/truck-inspection", "/truck-inspection/manifest.webmanifest", "/truck-inspection/icon.svg", "/truck-inspection/gear-wrench-180.png", "/truck-inspection/gear-wrench-192.png", "/truck-inspection/gear-wrench-512.png", "/api/truck-inspection"];
