...
import { ADDRESS_VERIFICATION_POLICY, verifyDesktopAddress } from '../lib/desktop-address-verification';
async function main() {
  let input = '';
  ...
  process.stdout.write(JSON.stringify({...await verifyDesktopAddress(body.address),verificationPolicy:ADDRESS_VERIFICATION_POLICY}));
}
