...
export const job = (values: Partial<Parameters<typeof buildCrewProgress>[0]['appointments'][number]> = {}): Parameters<typeof buildCrewProgress>[0]['appointments'][number] => ({
  ...
  customerName:'Example customer',customerEmail:'customer@example.invalid',customerEmailCollected:false,phone:'(504) 555-0100',address:'100 Example Street, New Orleans',territory:'New Orleans',appointmentType:'Job',status:'Completed',truck:'Truck 2',driver:'Example driver',navigator:'Example navigator',paymentType:'Cash',paymentAmount:450,tipAmount:0,completedAt:'2026-09-07T14:10:00Z',
  closeout:{loadQuantity:1,loadSize:'Half truck',loadPrice:450,bedloadQuantity:0,bedloadSize:'',bedloadPrice:0,otherCharges:[],discount:0,tip:0,total:450,payments:[{method:'Cash',detail:'',amount:450}],balance:0},photos:[],photoAuditAvailable:true,junkItems:['Two mattresses','Desk'],pickupItems:['Two queen mattresses, one desk, and four patio chairs'],appointmentNotes:['Use the side entrance. Call before arrival.'],cancellationReason:'',...values,
});
