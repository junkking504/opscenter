...
const snapshot:DesktopFleetSnapshot={date,report:'overview',canWrite:true,sourceAvailable:true,sourceUpdatedAt:new Date().toISOString(),reportCoverageDays:15,warnings:['Truck# 4: load reconciliation needs attention. Check the pickup order.'],
  trucks:[2,4].map(id=>({id:`Truck# ${id}`,label:`Truck# ${id}`,vehicle:'Example truck',readiness:id===2?'Ready':'Out of service',operatingStatus:'Parked',driver:'Example driver',navigator:'Not assigned',assignment:'None',location:'Unavailable',gpsAt:null,gpsFreshness:'GPS unavailable',odometer:'Unavailable',serviceStatus:'Unavailable',nextService:'No source target',checklist:'Complete',loadPercent:id===2?50:0,loadLabel:id===2?'1/2 full':'Empty · provisional',loadNeedsVerification:id===4,loadNote:'Example inspection and load evidence',loadVersion:'fixture',checklistVersion:'fixture',checklists:{daily:check,weekly:check,monthly:check},checklistDefinitions:check.definitions,answers:check.answers,jobs:2,revenue:400,miles:null,idleMinutes:null,driverScore:null})),
  issues:[{issueId:'repair-4',truck:'Truck# 4',title:'Tire replacement',description:'Example tire issue',severity:'out_of_service',status:'open',owner:'Existing shop',dueDate:'2026-09-18',resolution:'',cost:null,downtimeHours:null,updatedAt:date,version:'fixture'}],maintenance:[],reportRows:[{truck:'Truck 4',jobsCompleted:2,revenue:400,miles:12,idleTimeMinutes:0,averageDriverScore:null}],drivingScores:[]};
