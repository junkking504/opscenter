...
export function publicAuthRoute(pathname: string): boolean {
  ...
  if (pathname === '/crew-jobs/manifest.webmanifest' || pathname === '/crew-jobs/icon.png' || pathname === '/crew-jobs/waypoint-compass-crown-v1-32.png' || pathname === '/crew-jobs/waypoint-compass-crown-v1-180.png' || pathname === '/crew-jobs/waypoint-compass-crown-v1-192.png' || pathname === '/crew-jobs/waypoint-compass-crown-v1-512.png' || pathname === '/crew-jobs' || pathname === '/api/crew-jobs/session' || pathname === '/api/crew-jobs/current' || pathname === '/api/crew-jobs/photos' || pathname === '/api/crew-jobs/closeout' || pathname === '/api/crew-jobs/day') return true;
