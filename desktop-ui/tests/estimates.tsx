...
const initial:EstimateSnapshot={today:'2026-09-10',generatedAt:'2026-09-10T16:00:00Z',recentStart:'2026-08-01',coverage:{files:42,unreadable:0,latestObservation:'2026-09-10T12:00:00Z'},canWrite:true,actor:'Synthetic Operator',rows:[row('100'),row('101',{status:'converted',bookings:[{id:'201',jk:'JK201',date:'2026-09-12',status:'Confirmed',observedAt:'2026-09-10T12:00:00Z'}]}),row('102',{status:'lost',tracked:true,followup:{...followup,status:'lost',reason:'Customer no longer needs removal.'}}),row('103',{status:'waiting',tracked:true,followup:{...followup,status:'waiting',owner:'Synthetic Owner',nextFollowup:'2026-09-09',reason:'Approval expected tomorrow'},overdue:true}),row('104',{date:'2025-01-01',quote:null,ageDays:617}),row('105',{possibleBookings:[{id:'205',jk:'JK205',date:'2026-09-12',status:'Confirmed',observedAt:'2026-09-10T12:00:00Z'}]})]};
