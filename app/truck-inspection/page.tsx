...
export const metadata: Metadata = { title: { absolute: "Convoy" }, applicationName: "Convoy", icons: { icon: { url: "/truck-inspection/convoy-truck-v1-32.png", sizes: "32x32", type: "image/png" }, apple: { url: "/truck-inspection/convoy-truck-v1-180.png", sizes: "180x180", type: "image/png" } }, manifest: "/truck-inspection/manifest.webmanifest", appleWebApp: { capable: true, title: "Convoy", statusBarStyle: "default" }, robots: { index: false, follow: false } };
