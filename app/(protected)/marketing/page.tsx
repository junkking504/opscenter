...
function GoogleReviewsLocationSection({ reviews }: { reviews: GoogleReviewsView }) {
  ...
  const businessProfileSource = reviews.snapshot?.source === "google_business_profile_api";
