...
export const hierarchyAgents: AgentDefinition[] = [
  ...
  role('data-manager','Data manager','engineering','Supervise source-specific ownership, preserve source timestamps and precedence, and route cross-source disagreements without re-collecting provider data.'),
  role('junkware-source','JunkWare data agent','data-manager','Own JunkWare collection health, verified schedule and operating-record coverage, and source-specific recovery evidence.',['JunkWare']),
  role('qbo-source','QuickBooks data agent','data-manager','Own QuickBooks Online connection health, accounting snapshot coverage, and source-specific recovery evidence.',['QuickBooks']),
  role('wex-source','WEX data agent','data-manager','Own posted WEX import coverage and clearly distinguish retained exports from a fresh portal read.',['WEX']),
  role('linxup-source','LinxUp data agent','data-manager','Own LinxUp telemetry collection health, GPS coverage, and source-specific recovery evidence.',['LinxUp']),
  ...
  role('dispatch','Dispatch specialist','control','Review assignments, unresolved service locations, route progress and outstanding appointment actions.',['JunkWare','truck-assessments','schedule-addresses']),
  ...
  role('integrations','Other integrations and recovery','engineering','Review non-core integrations, blocked address recovery, and unclassified source failures; preserve source precedence.',['maintenance-observer','address-research']),
