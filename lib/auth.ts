...
export const AUTH_PUBLIC_FILES = [
  "/junk-king-logo.svg",
...
export const AUTH_PROTECTED_API_PREFIXES = ["/api/exceptions", "/api/inbox", "/api/fleet-map", "/api/fleet-maintenance", "/api/fleet-checklists", "/api/fleet-checklist-templates", "/api/fleet-checklist-photos", "/api/fleet-issues", "/api/fleet-issue-photos", "/api/manual-bonuses", "/api/searchkings", "/api/integrations/qbo/status", "/api/integrations/qbo/disconnect", "/api/integrations/qbo/payments"] as const;
