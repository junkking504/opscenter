...
window.fetch=async(input,init)=>{
  ...
  if(init?.method==='POST') {
    ...
    writes.push(body); assignments.set(body.recordId,body.values.truck);
    window.dispatchEvent(new Event('fixture-write'));
    return Response.json({receipt:{requestId:body.requestId,status:'verified',message:`Synthetic move verified to ${body.values.truck || 'Unassigned'}.`}});
  }
