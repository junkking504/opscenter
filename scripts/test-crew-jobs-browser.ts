...
async function main(){
 ...
 try{
  for(const width of [320,390,430]){
   ...
   await expect(page.getByRole('link',{name:'Open full schedule',exact:true})).toHaveAttribute('href','https://ops.junk-king.app/desktop?workspace=Schedule&scheduleDay=today&scheduleView=board');
