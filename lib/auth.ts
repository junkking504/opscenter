...
export const AUTH_PUBLIC_FILES = ["/junk-king-logo.svg", "/opscenter-icon.svg", "/opscenter-apple-icon.png", "/opscenter-logo.png", "/opscenter-favicon.png", "/favicon.ico", "/opscenter-app-192.png", "/opscenter-app-512.png", "/opscenter.webmanifest"] as const;
...
export function publicAuthRoute(pathname: string): boolean {
  ...
  if (pathname === '/crew-jobs/manifest.webmanifest' || pathname === '/crew-jobs/icon.png' || pathname === '/crew-jobs/waypoint-favicon-v2.png' || pathname === '/crew-jobs/waypoint-crown-road-v1-32.png' || pathname === '/crew-jobs/waypoint-crown-road-v1-180.png' || pathname === '/crew-jobs/waypoint-crown-road-v1-192.png' || pathname === '/crew-jobs/waypoint-crown-road-v1-512.png' || pathname === '/crew-jobs/waypoint-compass-crown-v2-32.png' || pathname === '/crew-jobs/waypoint-compass-crown-v2-180.png' || pathname === '/crew-jobs/waypoint-compass-crown-v2-192.png' || pathname === '/crew-jobs/waypoint-compass-crown-v2-512.png' || pathname === '/crew-jobs/waypoint-compass-crown-v1-32.png' || pathname === '/crew-jobs/waypoint-compass-crown-v1-180.png' || pathname === '/crew-jobs/waypoint-compass-crown-v1-192.png' || pathname === '/crew-jobs/waypoint-compass-crown-v1-512.png' || pathname === '/crew-jobs' || pathname === '/api/crew-jobs/session' || pathname === '/api/crew-jobs/current' || pathname === '/api/crew-jobs/photos' || pathname === '/api/crew-jobs/closeout' || pathname === '/api/crew-jobs/day' || pathname === '/api/crew-jobs/inspection' || pathname === '/api/crew-jobs/switch-truck') return true;
  // The truck-phone surface has its own narrowly scoped device authentication.
  if (["/truck-inspection", "/truck-inspection/manifest.webmanifest", "/truck-inspection/icon.svg", "/truck-inspection/brand-logo.svg", "/truck-inspection/convoy-gear-crown-v2-32.png", "/truck-inspection/convoy-gear-crown-v2-180.png", "/truck-inspection/convoy-gear-crown-v2-192.png", "/truck-inspection/convoy-gear-crown-v2-512.png", "/truck-inspection/convoy-gear-crown-v1-32.png", "/truck-inspection/convoy-gear-crown-v1-180.png", "/truck-inspection/convoy-gear-crown-v1-192.png", "/truck-inspection/convoy-gear-crown-v1-512.png", "/truck-inspection/convoy-truck-v1-32.png", "/truck-inspection/convoy-truck-v1-180.png", "/truck-inspection/convoy-truck-v1-192.png", "/truck-inspection/convoy-truck-v1-512.png", "/truck-inspection/gear-wrench-clean-180.png", "/truck-inspection/gear-wrench-clean-192.png", "/truck-inspection/gear-wrench-clean-512.png", "/truck-inspection/junk-king-gear-wrench-180.png", "/truck-inspection/junk-king-gear-wrench-192.png", "/truck-inspection/junk-king-gear-wrench-512.png", "/truck-inspection/gear-wrench-180.png", "/truck-inspection/gear-wrench-192.png", "/truck-inspection/gear-wrench-512.png", "/api/truck-inspection"].includes(pathname)) return true;
...
export function protectedApiRoute(pathname: string): boolean {
  if (pathname === '/api/crew-phones' || pathname === '/api/crew-dispatch' || pathname.startsWith('/api/crew-jobs/')) return true;
