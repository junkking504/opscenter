...
expect(detector.includes("while true; do"), "Detector must remain persistent");
expect(detector.includes("duration_seconds"), "Detector heartbeat must expose measured runtime");
