...
export function jobCloseoutTemplate(): string {
  return [
    "Send the JK number, every priced item, job times, category, and payment. Use one line per item.",
    "",
    "Example:",
    "Close JK4051234",
    ...
    "8:30 AM - 10:15 AM",
    "Credit Card $684.19 last4 4242",
    "",
    "Available individually priced items:",
    chargeCatalogText(),
    "",
    "For quantity above 1, include @ or 'each' so the unit price is unambiguous.",
  ].join("\n");
}
