...
const snapshot: SearchKingsSnapshot = {
  ...
  calls: {
    ...
    calls: [
      ...
      { id: "lost", name: "Lost Caller", callerNumberComplete: "+1 225 555 0102", city: "Baton Rouge", score: 5, tagList: ["Availability objection"], reportingTag: "Agent quoted $250; customer declined.", trackingLabel: "Baton Rouge LSA", duration: "02:00", calledAtDate: "2026-08-01", calledAtTime: "9:00 AM", audio: "https://example.com/not-searchkings.wav" },
