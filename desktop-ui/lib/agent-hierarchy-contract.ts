...
export const hierarchyAgents: AgentDefinition[] = [
  ...
  role('integrations','Integrations and data reliability','engineering','Review source failures and blocked address recovery; preserve source precedence.',['maintenance-observer','address-research']),
