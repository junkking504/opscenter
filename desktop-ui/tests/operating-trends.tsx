...
const finance = { date: '2026-09-25', daily: { revenue: 1200 }, operatingTrends: data, trendComparisons: { '2026-08': { yearPrior: { revenue: 45000, jobs: 180, averageJob: 250 } } }, trends: [{ monthKey: '2026-08', monthDisplay: 'August 2026', dataThroughDate: '2026-08-31', grossRevenue: 50000, completedJobs: 200, complete: true, revenueSource: 'junkware-monthly-dashboard', revenueCovered: true }, { monthKey: '2026-09', monthDisplay: 'September 2026', dataThroughDate: '2026-09-25', grossRevenue: 60000, completedJobs: 240, complete: false, revenueSource: 'junkware-monthly-dashboard', revenueCovered: true }] } as FinanceData;
finance.trends.push({ ...finance.trends[0], monthKey: '2025-09', monthDisplay: 'September 2025', dataThroughDate: '2025-09-30', grossRevenue: 65000, completedJobs: 260, complete: false, reportingComplete: true, missingDates: ['2025-09-02'] });
