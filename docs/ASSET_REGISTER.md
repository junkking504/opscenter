...
| Dispatch Krewe notes | `/Users/missioncontrol/.openclaw/workspace/opsbot/data/job-crew-notes/notes.json` | Dispatch-authored appointment instructions and their audit metadata; retain as protected operational state |
