...
const cases: Array<[string, string, string, string]> = [
  ...
  ['13957 Barrington Ave, Port Vincent, LA 70726', 'Baton Rouge', 'BR', 'LIV'],
  ['11778 Milldale Rd, Zachary, LA 70791', 'Baton Rouge', 'BR', 'BR'],
  ['11778 Milldale Rd, 70791', 'Baton Rouge', 'BR', 'BR'],
  ['7280 Ponderosa Ln, Addis, LA 70710', 'Baton Rouge', 'BR', 'WBR'],
  ['7280 Ponderosa Ln, 70710', 'Baton Rouge', 'BR', 'WBR'],
  ['2925 Church St, Jackson, LA 70748', 'Baton Rouge', 'BR', 'EF'],
  ['2925 Church St, 70748', 'Baton Rouge', 'BR', 'EF'],
