...
```text
GOOGLE_REVIEWS_PLACE_ID=places/...
GOOGLE_MAPS_API_KEY=...
```
...
- `data/google-reviews/current.json` — newest verified public snapshot
- `data/history/google-reviews/google-reviews_YYYY-MM-DD.json` — daily history
