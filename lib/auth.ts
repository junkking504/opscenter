...
export function publicAuthRoute(pathname: string): boolean {
  ...
  if (pathname === '/crew-jobs' || pathname === '/api/crew-jobs/session' || pathname === '/api/crew-jobs/current' || pathname === '/api/crew-jobs/photos' || pathname === '/api/crew-jobs/closeout') return true;
