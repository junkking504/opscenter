...
assert.equal(formatSlackAlert(events.find((event) => event.kind === "job_closed")!.alert), [
  ":moneybag: *Job Completed - Baton Rouge -* *<https://ops.junk-king.app/jobs?date=2026-08-17#job-jk4051001|JK4051001>* *- 9:00 AM - Truck 6*",
  "*C:* Test Customer  |  *D:* Test Driver  |  *N:* Test Navigator",
  "*Load:* $500.00 (1/4)",
  "*Payment:* $500.00 (xx-1234)",
].join("\n"));
...
assert.equal(formatSlackAlert(events.find((event) => event.kind === "estimate_closed")!.alert), [
  ":moneybag: *Estimate Completed - Baton Rouge -* *<https://ops.junk-king.app/jobs?date=2026-08-17#job-jk4051006|JK4051006>* *- 4:00 PM - Truck 6*",
