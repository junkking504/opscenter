...
const metrics = { total_revenue: 1200, total_payroll: 180, dump_expense: 125, fuel_expense: 75, total_expenses: 500, net_profit: 700, completed_jobs: 3, revenue_by_truck: { 'Truck 3': 800, 'Truck 9': 400 }, employee_leaderboard: [{ hours_worked: 4 }, { hours_for_rph: 6, hours_worked: 8 }] };
