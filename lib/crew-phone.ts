...
export const CREW_JOBS_PUBLIC_PATHS = ['/crew-jobs', '/crew-jobs/manifest.webmanifest', '/crew-jobs/icon.png', '/crew-jobs/waypoint-compass-crown-v2-32.png', '/crew-jobs/waypoint-compass-crown-v2-180.png', '/crew-jobs/waypoint-compass-crown-v2-192.png', '/crew-jobs/waypoint-compass-crown-v2-512.png', '/crew-jobs/waypoint-compass-crown-v1-32.png', '/crew-jobs/waypoint-compass-crown-v1-180.png', '/crew-jobs/waypoint-compass-crown-v1-192.png', '/crew-jobs/waypoint-compass-crown-v1-512.png', '/api/crew-jobs/session', '/api/crew-jobs/day', '/api/crew-jobs/inspection', '/api/crew-jobs/current', '/api/crew-jobs/photos', '/api/crew-jobs/closeout'];
