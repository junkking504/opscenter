...
assert.equal((await get([job('onsite',{truckOnSite:true}),second],[parked]))[0].status,'on_site','Keep GPS-established on-site state through the parked heartbeat window');
