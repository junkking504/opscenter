...
export default function FleetInspectionReports() {
  ...
  return <main className={`${styles.app} ${styles.managerApp}`}>
    ...
    <div className={styles.manage}>
      ...
      {snapshot.canManage && <details id="phone-management" className={`${styles.card} ${styles.noPrint}`} open={manageOpen} onToggle={e => setManageOpen(e.currentTarget.open)}><summary><strong>Manage truck phones</strong></summary><p>Use <a href="https://waypoint.junk-king.app/crew-jobs?tab=inspections">Waypoint</a> for jobs, inspections and crew. <a href="/crew-phones">Set up company phones</a> and assign each phone to its truck.</p><p className={styles.muted}>Connections below belong to the previous inspection app. Unfinished drafts can still be completed there; new inspections use Waypoint. Disconnect ends the legacy connection.</p>
